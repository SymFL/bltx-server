...
@MapperScan(basePackages = "com.csk2024.bltx.mapper")
public class BltxServerApplication implements CommandLineRunner {
    ...
    public static void main(String[] args) {
        SpringApplication.run(BltxServerApplication.class, args);
    }
